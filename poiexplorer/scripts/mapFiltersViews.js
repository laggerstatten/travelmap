    ...
    for (const id of toggleableLayerIds) {
        if (!document.getElementById(id)) {
            ...
            link.onclick = function (e) {
                ...
                const visibility = map.getLayoutProperty('road-label-navigation', 'visibility');

                // Toggle layer visibility by changing the layout object's visibility property.
                if (visibility === 'visible') {
                    map.setLayoutProperty('road-intersection', 'visibility', 'none');
                    map.setLayoutProperty('road-label-navigation', 'visibility', 'none');
                    map.setLayoutProperty('road-number-shield-navigation', 'visibility', 'none');
                    map.setLayoutProperty('road-exit-shield-navigation', 'visibility', 'none');
                    this.className = '';
                } else {
                    this.className = 'active';
                    map.setLayoutProperty('road-intersection', 'visibility', 'visible');
                    map.setLayoutProperty('road-label-navigation', 'visibility', 'visible');
                    map.setLayoutProperty('road-number-shield-navigation', 'visibility', 'visible');
                    map.setLayoutProperty('road-exit-shield-navigation', 'visibility', 'visible');
                }
            };
